"""
Incremente a nouveau la version Android (3eme republication) avant de
generer un nouveau .aab.
A lancer UNE SEULE FOIS depuis le dossier orania-frontend.

Usage :
    python incrementer_version_v3.py
"""
...
def main():
    ...
    print("\n" + ("Version incrementee avec succes !" if tout_ok else "Termine avec au moins un echec -- si le numero actuel est different, dis-le moi (Select-String -Path android\\app\\build.gradle -Pattern 'versionCode|versionName')."))
